(function(){
	...
	app.controller("portfolioController",function($rootScope,$scope,Page,$window,$http,$location,$timeout,$anchorScroll,$interval){
		console.log("app.portfolioController");
		...
		console.log("app.portfolioController.end");
	});
