(function(){
	...
	app.controller("aboutController",function($rootScope,$scope,Page,$window,$http,$location,$timeout,$anchorScroll,$interval){
		...
		$scope.getTeamTitle3=function(){
			if($rootScope.language=="es"){
				return "Equipo de asesores";
			}else if($rootScope.language=="en"){
				return "management advisory team";
			}
		};
		...
		console.log("app.aboutController.end");
	});
